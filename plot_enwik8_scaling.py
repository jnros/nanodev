"""DiffusionBlocks x nanoGPT — enwik8 CE gap and VRAM vs depth.

Reads output dirs from the enwik8 depth-scaling sweep and renders
enwik8_scaling_depth.png.  Same structure as plot_dblock_scaling.py so
artifacts can be overlaid manually later.
Run: uv run python plot_enwik8_scaling.py
"""
import json
import os
...
DBLOCK_DIRS = {
    6:  'out-enwik8-dblock-L6-B3',
    8:  'out-enwik8-dblock-L8-B4',
    10: 'out-enwik8-dblock-L10-B5',
    12: 'out-enwik8-dblock-L12-B6',
}
...
def main():
    ...
    fig.tight_layout()
    out = 'enwik8_scaling_depth.png'
    fig.savefig(out, dpi=150)
    print(f"saved {out}")

    print(f"\n{'L':>4}  {'base CE':>8}  {'dblock CE':>10}  {'gap':>6}  "
          f"{'base MB':>8}  {'dblock MB':>10}")
